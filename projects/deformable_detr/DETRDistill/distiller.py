...
class Distiller(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        # original features
        with torch.no_grad():
            output_t,teacher_query = self.teacher.forward_teacher(images,img_masks,targets,self.max_per_img)
        output_s = self.student.forward_student(images,img_masks,teacher_query) 

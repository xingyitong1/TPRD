...
from .distill_dino_r18 import model as student_model
from .distill_dino_r50 import model as teacher_model

from projects.dino.KD_DETR_TPRD import (
    Distiller,
    DistillCriterion
)
...
model = L(Distiller)(
    ...
    distill_criterion=L(DistillCriterion)(
        ...
        weight_dict={
            # auxilary query loss
            "auxilary_loss_class": 4.0,
            "auxilary_loss_bbox": 5.0,
            "auxilary_loss_giou": 2.0,
            # teacher query loss
            "teacher_loss_class": 2.0,
            "teacher_loss_bbox": 20.0,
            "teacher_loss_giou" : 8.0,
        },
    ),
    general_points = 300,

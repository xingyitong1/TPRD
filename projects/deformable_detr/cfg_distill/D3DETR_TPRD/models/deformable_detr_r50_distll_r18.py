...
model = L(Distiller)(
    ...
    distill_criterion=L(DistillCriterion)(
        ...
        losses = ["class","boxes","attn"],
        weight_dict={
            # distill loss
            "distill_loss_class": 3.0,
            "distill_loss_bbox": 5.0,
            "distill_loss_giou": 2.0,
            # teacher query loss
            "teacher_loss_class": 3.0,
            "teacher_loss_bbox": 5.0,
            "teacher_loss_giou" : 2.0,
            # attn distillation
            "distill_loss_self_attn": 10000.0,
            "distill_loss_cross_attn": 1000.0,
            "teacher_loss_self_attn": 10000.0,
            "teacher_loss_cross_attn": 1000.0,
        },
    ),

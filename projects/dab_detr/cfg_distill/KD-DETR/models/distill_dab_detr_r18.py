...
from projects.dab_detr.KD_DETR import (
    DistillDABDETR,
    DistillDabDetrTransformer
)
...
model = L(DistillDABDETR)(
    ...
    in_channels=512, # res5 output channels
    position_embedding=L(PositionEmbeddingSine)(
        num_pos_feats=128,
        temperature=20,
        normalize=True,
    ),
    transformer=L(DistillDabDetrTransformer)(

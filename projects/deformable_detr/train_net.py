...
def do_train(args, cfg):
    ...
    if isinstance(start_iter, float):   
        start_iter = int(start_iter)
    if isinstance(cfg.train.max_iter, float):
        cfg.train.max_iter = int(cfg.train.max_iter)

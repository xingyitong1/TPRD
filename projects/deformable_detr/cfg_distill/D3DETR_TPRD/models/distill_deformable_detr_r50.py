...
from projects.deformable_detr.D3DETR_TPRD import (
    DistillDeformableDETR,
    DistillDeformableDetrTransformer,
    DistillDeformableDetrTransformerDecoder
)
...
model = L(DistillDeformableDETR)(
    ...
    transformer=L(DistillDeformableDetrTransformer)(
        ...
        decoder=L(DistillDeformableDetrTransformerDecoder)(
            embed_dim=256,
            num_heads=8,
            feedforward_dim=1024,
            attn_dropout=0.1,

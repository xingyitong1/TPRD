...
class MultiScaleDeformableAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs
        ...
        # 传递给hook使用
        self.attn_cache = {}
        self.attn_cache["sampling_locations"] = sampling_locations
        self.attn_cache["attention_weights"] = attention_weights
        self.attn_cache["spatial_shapes"] = spatial_shapes
        self.attn_cache["level_start_index"] = level_start_index

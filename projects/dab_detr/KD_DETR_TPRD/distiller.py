...
class Distiller(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        aux_box_embed = torch.nn.Embedding(self.general_points, 4 , device=self.device).weight
        # original features
        with torch.no_grad():
            output_t,teacher_box_embed = self.teacher.forward_teacher(images,img_masks,aux_box_embed)
        output_s = self.student.forward_student(images,img_masks,aux_box_embed,teacher_box_embed) 

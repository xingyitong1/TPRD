...
def default_coco_scheduler(epochs=50, decay_epochs=40, warmup_epochs=0,scaler = 1):
    """
    ...
    """
    # total number of iterations assuming 16 batch size, using 1440000/16=90000
    total_steps_16bs = epochs * 7500 * scaler
    decay_steps = decay_epochs * 7500 * scaler
    warmup_steps = warmup_epochs * 7500 * scaler
    scheduler = L(MultiStepParamScheduler)(
        values=[1.0, 0.1],
